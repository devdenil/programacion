...
<div class="card">
    ...
    <div class="card-body">
        @can('create-user')
            <a href="{{ route('users.create') }}" class="btn btn-primary mb-4"><i class="bi bi-plus-circle"></i> Nuevo Usuario</a>
        @endcan
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('users.destroy', $user->id) }}" method="post">
                            ...
                            <a href="{{ route('users.show', $user->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Detalles</a>
